// Static data tables (extracted Stage 2)
export const COUNTY_ASSESSORS = {
...
export const DEF_COUNTY = {phone:"See county recorder website",url:"",eRecord:false,vendors:[],note:"Verify current fees and requirements with the county recorder before recording."};
